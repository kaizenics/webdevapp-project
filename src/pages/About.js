        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full md:w-2/3 p-4">
            <p className="text-gray-800 mb-4 text-3xl">
              Hi, my name is Nicose John Gallaza Soriano and I'm a Information Technology Student. I'm into Technology and that is why i take the Information Technology Student.
            </p>
